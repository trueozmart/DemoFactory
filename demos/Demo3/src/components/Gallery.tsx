...
import project6 from "@/assets/gallery/construction-project-6.jpg";
import project7 from "@/assets/gallery/construction-project-7.jpg";
...
const galleryImages: GalleryImage[] = [
  { src: project1, suburb: "Atherton", service: "Drainage & Stonework" },
  { src: project2, suburb: "Cairns", service: "Commercial Scaffolding" },
  { src: project3, suburb: "Mareeba", service: "Outdoor Landscaping & Stonework" },
  { src: project4, suburb: "Atherton", service: "Earthworks & Excavation" },
  { src: project5, suburb: "Yungaburra", service: "Bathroom Renovation" },
  { src: project6, suburb: "Atherton", service: "Timber Pergola Build" },
  { src: project7, suburb: "Atherton", service: "Commercial Fitout" },
];
      ...
      <div className="container-custom">
        <div className="text-center mb-10 md:mb-14">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse our completed construction projects across the Atherton Tablelands.
          </p>
        </div>
