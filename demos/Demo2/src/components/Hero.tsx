    ...
    <section className="relative min-h-[100svh] flex items-center pt-16 md:pt-20">
      ...
      <div className="relative z-10 container-custom px-5 md:px-8 py-8 md:py-24">
        <div className="max-w-2xl text-center mx-auto lg:text-left lg:mx-0">
          ...
          >
            Quality Construction & <span className="text-accent drop-shadow-lg">Civil Works</span>
          </h1>
          ...
          >
            Serving Government, Commercial & Community Clients
          </p>
          <p
          ...
          >
            Delivering building, civil and playground projects across the Atherton Tablelands, Cairns and surrounding regions.
          </p>
