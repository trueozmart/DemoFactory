        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="animate-fade-in-up text-center">
            ...
            <p className="text-sm md:text-lg text-muted-foreground mb-5 md:mb-6 max-w-lg mx-auto lg:mx-0 leading-relaxed">
              Get in touch to discuss scope, timelines and project requirements. We're available for government, commercial and community projects.
            </p>
            ...
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="font-bold text-foreground text-base md:text-lg">0437 831 423</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-card rounded-xl border border-border">
                ...
                <div className="text-left">
                  ...
                  <p className="font-bold text-foreground text-sm md:text-base">128 Herberton Rd, Atherton QLD 4883</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-card rounded-xl border border-border">
                ...
                <div className="text-left">
                  ...
                  <div className="flex items-center gap-1.5 md:gap-2">
                    ...
                    <span className="text-muted-foreground text-xs md:text-sm">(Google Reviews)</span>
                  </div>
                </div>
              </div>
            </div>
