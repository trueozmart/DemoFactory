      ...
      <div className="container-custom section-padding">
        <div className="grid gap-8 md:gap-12 lg:gap-16 md:grid-cols-3">
          ...
          <div className="text-center md:text-left">
            <div className="mb-3 md:mb-4 flex justify-center md:justify-start">
              <img src={logo} alt="Chatfield Constructions" className="h-14 md:h-16 w-auto" />
            </div>
            <p className="text-primary-foreground/80 mb-4 md:mb-6 leading-relaxed text-sm md:text-base">
              Reliable. Safe. Built to last.
            </p>
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <span className="text-primary-foreground/80 text-xs md:text-sm">5.0 Google Reviews</span>
            </div>
          </div>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3 md:space-y-4 mb-5 md:mb-6">
              <a href="tel:+61437831423" className="flex items-center justify-center md:justify-start gap-2 md:gap-3 text-primary-foreground/80 text-sm hover:text-accent transition-colors">
                <Phone className="w-3.5 h-3.5 md:w-4 md:h-4 text-accent flex-shrink-0" />
                <span>0437 831 423</span>
              </a>
              <div className="flex items-center justify-center md:justify-start gap-2 md:gap-3 text-primary-foreground/80 text-sm">
                ...
                <span>128 Herberton Rd, Atherton QLD 4883</span>
              </div>
            </div>
            <a href="tel:+61437831423">
        ...
        <div className="border-t border-primary-foreground/10 mt-8 md:mt-12 pt-6 md:pt-8">
          <p className="text-center text-primary-foreground/60 text-xs md:text-sm">
            © {new Date().getFullYear()} Chatfield Constructions. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
