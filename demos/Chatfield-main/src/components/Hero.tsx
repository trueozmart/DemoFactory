      ...
      <div className="relative z-10 container-custom px-5 md:px-8 py-8 md:py-24">
        <div className="max-w-2xl text-center mx-auto lg:text-left lg:mx-0">
          ...
          <div className="inline-flex items-center gap-2 bg-card/95 backdrop-blur-sm rounded-full px-3 py-1.5 md:px-4 md:py-2 mb-4 md:mb-6 animate-fade-in-up">
            ...
            <span className="font-semibold text-foreground text-sm md:text-base">5.0 Google Reviews</span>
          </div>
          ...
          >
            Roller Doors & <span className="text-accent drop-shadow-lg">Custom Sheds</span>
          </h1>
          ...
          >
            Supply, Installation & Repairs for Homes & Businesses
          </p>
          <p
          ...
          >
            Durable, customisable roller doors and shed solutions built to secure and protect your property — backed by local expertise and Australian-made products.
          </p>
          ...
          >
            ...
            <span>Australian-Made Products</span>
            <span className="opacity-60 hidden sm:inline">•</span>
