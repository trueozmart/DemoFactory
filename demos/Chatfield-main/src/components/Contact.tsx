        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="animate-fade-in-up text-center">
            ...
            <p className="text-sm md:text-lg text-muted-foreground mb-5 md:mb-6 max-w-lg mx-auto lg:mx-0 leading-relaxed">
              Call us today for a free measure and quote. We're available for roller door installations, custom sheds, repairs and maintenance across the area.
            </p>
            ...
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="font-bold text-foreground text-base md:text-lg">0422 652 987</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-card rounded-xl border border-border">
                ...
                <div className="text-left">
                  <p className="text-xs md:text-sm text-muted-foreground">Service Area</p>
                  <p className="font-bold text-foreground text-sm md:text-base">Contact us for service area details</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-card rounded-xl border border-border">
                ...
                <div className="text-left">
                  ...
                  <div className="flex items-center gap-1.5 md:gap-2">
                    ...
                    <span className="text-muted-foreground text-xs md:text-sm">(5-Star Reviews)</span>
                  </div>
                </div>
              </div>
            </div>
